...
PARAM$ranger <- list(
  "num.trees" = 473, # cantidad de arboles
  ## Claude: buen punto de partida: 500. Puede subir hasta 1k o 2k si mejora rend
  "mtry" = 12, # cantidad de atributos que participan en cada split
  ## claude: sqrt(cant de variables) -> sqrt(155 creo) en vivencial -> entre 12 y13
  "min.node.size" = 781, # tamaño minimo de las hojas
  ## 1 para clasif. Pero aumentarlo puede ayudar con el overfit
  "max.depth" = 23 # 0 significa profundidad infinita
  ## Un buen rango es entre 10 y 30.
)
