...
PARAM$ranger <- list(
  "num.trees" = 462, # cantidad de arboles
  "mtry" = 30, # cantidad de atributos que participan en cada split - 155 columnas de mi dataset
  "min.node.size" = 264, # tamaño minimo de las hojas
