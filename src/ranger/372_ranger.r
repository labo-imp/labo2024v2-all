...
PARAM$ranger <- list(
  "num.trees" = 434, # cantidad de arboles
  "mtry" = 25, # cantidad de atributos que participan en cada split
  "min.node.size" = 65, # tamaño minimo de las hojas
  "max.depth" = 3 # 0 significa profundidad infinita
)
