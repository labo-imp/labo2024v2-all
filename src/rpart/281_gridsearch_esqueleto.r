...
for (vcp in c(-0.01, -0.1, -0.005)) { # Loop para 'cp'
  for (vmax_depth in c(4, 6, 8, 10, 12, 14)) { 
    for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) { 
      for (vmin_bucket in c(1, 5, 10, 20)) { # Loop para 'minbucket'
        
        # Se crea la lista con los hiperparámetros en cada iteración
        param_basicos <- list(
        ...
        # Un solo llamado, con las semillas generadas
