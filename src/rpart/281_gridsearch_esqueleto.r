...
PARAM$semilla_primigenia <- 979457
PARAM$qsemillas <- 20
...
for (vcp in c(-0.8, -0.6, -0.4, -0.20, 0, 0.1)) {
  for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
    for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50)) {
      for (vminbucket in c(500, 400, 300, 200, 100, 50, 25)) {
        ...
        param_basicos <- list(
          ...
          "minbucket" = vminbucket # 5 # minima cantidad de registros en una hoja
        )
