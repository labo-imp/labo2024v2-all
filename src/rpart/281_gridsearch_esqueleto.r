...
PARAM$semilla_primigenia <- 354877
PARAM$qsemillas <- 40
...
for (vmax_depth in c(4, 6, 7, 8, 9, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10, 8, 7, 4)) {
    for (vmin_cp in c(-0.4, 0.0, -0.55)){
      for(vmin_bucket in c(100, 200, 500)){
