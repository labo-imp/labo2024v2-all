...
cp_values <- c(0.001, 0.01, 0.05)  # Complejidad mínima (ajustar según sea necesario)
maxdepth_values <- c(4, 6, 8, 10, 12, 14)  # Profundidad máxima
minsplit_values <- c(1000, 800, 600, 400, 200, 100, 50, 20, 10)  # Tamaño mínimo para dividir un nodo
minbucket_values <- c(5, 10, 20, 50)  # Tamaño mínimo de cada hoja
  ...
  for (vmax_depth in maxdepth_values) {
    for (vmin_split in minsplit_values) {
      for (vmin_bucket in minbucket_values) {
        ...
        # Llamada a la función para calcular la ganancia usando Montecarlo Cross Validation
