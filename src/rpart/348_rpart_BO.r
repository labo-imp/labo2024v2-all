...
PARAM$hs <- makeParamSet(
    ...
    makeIntegerParam("minsplit", lower = 1L, upper = 18000L), # Cantidad de registros/2
    makeIntegerParam("minbucket", lower = 1L, upper = 18000L), # Cantidad de registros/2
    makeIntegerParam("maxdepth", lower = 2L, upper = 80L),
