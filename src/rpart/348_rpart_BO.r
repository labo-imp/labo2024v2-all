...
PARAM$hs <- makeParamSet(
    # makeNumericParam("cp", lower = -1, upper = 0.1), #-1,1
    makeNumericParam("cp", lower = -1, upper = 1), #-1,1
    #makeIntegerParam("minsplit", lower = 1L, upper = 8000L), # mitad del registro del dataset
    makeIntegerParam("minsplit", lower = 1L, upper = 18000L), 
    #makeIntegerParam("minbucket", lower = 1L, upper = 4000L), # igual mitad de registro
    makeIntegerParam("minbucket", lower = 1L, upper = 18000L),
    #makeIntegerParam("maxdepth", lower = 3L, upper = 20L), # 30L max
