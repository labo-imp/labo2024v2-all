...
for (vmax_depth in c(5, 10, 15, 20, 25)) {
  for (vmin_split in c(1200, 1000, 800, 600, 400, 200)) {
    for (vcp in c(-0.8, -0.7, -0.5)) {
      for (vbucket in c(5, 10, 15, 20)) {
    ...
    param_basicos <- list(
      ...
      "minbucket" = vbucket # minima cantidad de registros en una hoja
    )
