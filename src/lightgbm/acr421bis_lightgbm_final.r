...
PARAM$finalmodel$num_iterations <- 230
PARAM$finalmodel$learning_rate <- 0.183042876653898
PARAM$finalmodel$feature_fraction <- 0.351712451991357
PARAM$finalmodel$min_data_in_leaf <- 558
PARAM$finalmodel$num_leaves <- 523

PARAM$finalmodel$max_bin <- 31

PARAM$finalmodel$lambda_l2 <- 124
