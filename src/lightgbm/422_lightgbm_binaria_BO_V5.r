...
hs <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 8L, upper = 1600L),
  makeNumericParam("feature_fraction", lower = 0.1, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 1L, upper = 5000L),
  makeIntegerParam("envios", lower = 1500L, upper = 10000L),
  makeNumericParam("lambda_l1", lower = 0.3, upper = 1),
  makeNumericParam("lambda_l2", lower = 0.3, upper = 1),
  makeNumericParam("min_gain_to_split", lower = 0.05, upper = 1),
