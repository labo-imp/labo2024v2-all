...
PARAM$finalmodel$num_iterations <- 150
PARAM$finalmodel$learning_rate <- 0.107200165383471
PARAM$finalmodel$feature_fraction <- 0.904570218336983
PARAM$finalmodel$min_data_in_leaf <- 548
PARAM$finalmodel$num_leaves <- 2377
PARAM$finalmodel$envios <- 2472
PARAM$finalmodel$max_depth <- 12
PARAM$finalmodel$lambda1 <- 0.118195972304366
PARAM$finalmodel$lambda2 <-29.9
