...
PARAM$finalmodel$num_iterations <- 200
PARAM$finalmodel$learning_rate <- 0.1619
PARAM$finalmodel$feature_fraction <- 0.83
PARAM$finalmodel$min_data_in_leaf <- 3469
PARAM$finalmodel$num_leaves <- 1699
