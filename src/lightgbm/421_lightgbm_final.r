...
PARAM$finalmodel$num_iterations <- 165
PARAM$finalmodel$learning_rate <- 0.143937559
PARAM$finalmodel$feature_fraction <- 0.682543677
PARAM$finalmodel$min_data_in_leaf <- 1584
PARAM$finalmodel$num_leaves <- 721
