...
PARAM$finalmodel$num_iterations <- 56
PARAM$finalmodel$learning_rate <- 0.0380364900326466
PARAM$finalmodel$feature_fraction <- 0.577104329994967
PARAM$finalmodel$min_data_in_leaf <- 5854
PARAM$finalmodel$num_leaves <- 486
PARAM$finalmodel$bagging_fraction <- 0.997122501650377
PARAM$finalmodel$lambda_l1 <- 0.0204769763317877
PARAM$finalmodel$lambda_l2 <- 0.558307903899682
