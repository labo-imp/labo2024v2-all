...
PARAM$finalmodel$num_iterations <- 8
PARAM$finalmodel$learning_rate <- 0.112724375060201
PARAM$finalmodel$feature_fraction <- 0.302920188150416
PARAM$finalmodel$min_data_in_leaf <- 167
PARAM$finalmodel$num_leaves <- 369
PARAM$finalmodel$envios <- 2387
PARAM$finalmodel$max_depth <- 13
PARAM$finalmodel$bagging_fraction <- 0.647656018267285
PARAM$finalmodel$lambda_l1 <- 4.26269416904604
PARAM$finalmodel$lambda_l2 <- 1.39704866352607
PARAM$finalmodel$min_gain_to_split <- 0.838116188513252
PARAM$finalmodel$bagging_freq <- 2
PARAM$finalmodel$max_bin <- 208
PARAM$finalmodel$min_sum_hessian_in_leaf <- 3.1820197510106
