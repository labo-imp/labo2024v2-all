...
PARAM$finalmodel$num_iterations <- 65
PARAM$finalmodel$learning_rate <- 0.153733058993557
PARAM$finalmodel$feature_fraction <- 0.525075638826639
PARAM$finalmodel$min_data_in_leaf <- 2863
PARAM$finalmodel$num_leaves <- 230

PARAM$finalmodel$max_bin <- 220
