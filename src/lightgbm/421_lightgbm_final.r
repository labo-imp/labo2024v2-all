...
PARAM$finalmodel$num_iterations <- 1040
PARAM$finalmodel$learning_rate <- 0.013201059
PARAM$finalmodel$feature_fraction <- 0.77
PARAM$finalmodel$min_data_in_leaf <- 717
