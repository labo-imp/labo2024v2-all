...
PARAM$finalmodel$num_iterations <- 335
PARAM$finalmodel$learning_rate <- 0.0443890415637625
PARAM$finalmodel$feature_fraction <- 0.766240523851152
PARAM$finalmodel$min_data_in_leaf <- 196
PARAM$finalmodel$num_leaves <- 91
PARAM$finalmodel$max_depth <- 8
PARAM$finalmodel$bagging_fraction <- 0.472032357168391
PARAM$finalmodel$bagging_freq <- 1
PARAM$finalmodel$lambda_l1 <- 8.736181355
PARAM$finalmodel$lambda_l2 <- 58.89619141
