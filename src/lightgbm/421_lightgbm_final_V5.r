...
PARAM$finalmodel$learning_rate <- 0.192743
PARAM$finalmodel$feature_fraction <- 0.83113
PARAM$finalmodel$min_data_in_leaf <- 4496
PARAM$finalmodel$num_leaves <- 1178
PARAM$finalmodel$min_gain_to_split <- 0.070035
PARAM$finalmodel$lambda1 <- 0.358804
PARAM$finalmodel$lambda2 <- 0.579837
PARAM$finalmodel$baggin_fraction <- 0.589106
PARAM$finalmodel$baggin_freq <- 0
PARAM$finalmodel$max_depth <- 16
