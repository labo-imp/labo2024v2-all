...
PARAM$experimento <- "HT4220-nuevo"
...
hs <- makeParamSet(
  ...
  makeIntegerParam("envios", lower = 1500L, upper = 3500L),
  ...
  makeNumericParam("min_split_gain", lower = 0, upper = 15),
  makeIntegerParam("max_bin", lower = 200L, upper = 300L),
  makeNumericParam("min_gain_to_split", lower = 0, upper = 1),
  makeIntegerParam("min_sum_hessian_in_leaf", lower = 1L, upper = 10L)
)
