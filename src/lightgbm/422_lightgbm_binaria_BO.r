...
hs <- makeParamSet(
  ...
  makeIntegerParam("envios", lower = 1000L, upper = 2000L),
  ...
  makeIntegerParam("num_iterations", lower = 100, upper = 10000),  # Añadido
  makeIntegerParam("max_bin", lower = 15, upper = 255),  # Añadido
  makeNumericParam("path_smooth", lower = 0.0, upper = 10.0)  # Añadido
)
