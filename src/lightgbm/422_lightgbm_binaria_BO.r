...
PARAM$experimento <- "HT4220.4" # CAMBIAR CARPETA EN CADA CORRIDA
...
hs <- makeParamSet(
  ...
  makeIntegerParam("num_leaves", lower = 20L, upper = 600L),
  makeNumericParam("feature_fraction", lower = 0.6, upper = 1),
  makeIntegerParam("min_data_in_leaf", lower = 1000L, upper = 6000L),
  makeIntegerParam("envios", lower = 1500L, upper = 2800L)
)
