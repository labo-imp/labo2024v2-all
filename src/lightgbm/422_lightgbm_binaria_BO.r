...
hs <- makeParamSet(
  makeNumericParam("learning_rate", lower = 0.008, upper = 0.02),
  makeIntegerParam("num_leaves", lower = 8L, upper = 1024L),
  makeNumericParam("feature_fraction", lower = 0.6, upper = 1.0),
  makeIntegerParam("min_data_in_leaf", lower = 300L, upper = 8000L),
  makeIntegerParam("envios", lower = 7000L, upper = 13500L),
  makeNumericParam("lambda_l1", lower = 0.5, upper = 0.75)
)
