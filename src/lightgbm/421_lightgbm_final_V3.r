...
PARAM$finalmodel$num_iterations <- 59
PARAM$finalmodel$learning_rate <- 0.093202
PARAM$finalmodel$feature_fraction <- 0.53386
PARAM$finalmodel$min_data_in_leaf <- 2921
PARAM$finalmodel$num_leaves <- 1313
PARAM$finalmodel$min_gain_to_split <- 0.865155
PARAM$finalmodel$lambda1 <- 0.613083
PARAM$finalmodel$lambda2 <- 0.359096
PARAM$finalmodel$baggin_fraction <- 0.604969
PARAM$finalmodel$baggin_freq <- 9
...
modelo <- lgb.train(
  ...
  param = list(
    ...
    lambda1 = PARAM$finalmodel$lambda1,
    lambda2 = PARAM$finalmodel$lambda2,
    baggin_fraction = PARAM$finalmodel$baggin_fraction,
    baggin_freq = PARAM$finalmodel$baggin_freq,
