...
PARAM$finalmodel$num_iterations <- 51

PARAM$finalmodel$learning_rate <- 0.1494011168169
PARAM$finalmodel$feature_fraction <- 0.836667751184914
PARAM$finalmodel$min_data_in_leaf <- 3297
PARAM$finalmodel$num_leaves <- 223
PARAM$finalmodel$max_depth <- 12
PARAM$finalmodel$bagging_fraction <- 0.846946118513618
PARAM$finalmodel$bagging_freq <- 7
PARAM$finalmodel$lambda_l1 <- 9.74168634735545
PARAM$finalmodel$lambda_l2 <- 0.322953411727392
PARAM$finalmodel$min_gain_to_split <- 0.0220772947725214
PARAM$finalmodel$envios <- 2130
