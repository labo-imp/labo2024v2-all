...
PARAM$finalmodel$num_iterations <- 64
PARAM$finalmodel$learning_rate <- 0.199437
PARAM$finalmodel$feature_fraction <- 0.131118
PARAM$finalmodel$min_data_in_leaf <- 2032
PARAM$finalmodel$num_leaves <- 113
PARAM$finalmodel$min_gain_to_split <- 0.326103
PARAM$finalmodel$lambda1 <- 0.798654
PARAM$finalmodel$lambda2 <- 0.486968
PARAM$finalmodel$baggin_fraction <- 0.947428
PARAM$finalmodel$baggin_freq <- 7
