...
PARAM$finalmodel$num_iterations <- 104
PARAM$finalmodel$learning_rate <- 0.1819688713
PARAM$finalmodel$feature_fraction <- 0.6801678394
PARAM$finalmodel$min_data_in_leaf <- 2086
PARAM$finalmodel$num_leaves <- 464
PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$min_gain_to_split <- 0.1039776678
PARAM$finalmodel$lambda_l1 <- 0.3954531300
PARAM$finalmodel$lambda_l2 <- 12.7022143387
PARAM$finalmodel$bagging_fraction <- 0.8816022651
PARAM$finalmodel$bagging_freq <- 4
PARAM$finalmodel$max_depth <- 7
PARAM$finalmodel$path_smooth <- 0.7399604030
PARAM$finalmodel$envios <- 2013
