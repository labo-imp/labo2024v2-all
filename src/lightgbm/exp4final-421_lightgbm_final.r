...
PARAM$finalmodel$learning_rate <- 0.0100025197
PARAM$finalmodel$num_leaves <- 480
PARAM$finalmodel$feature_fraction <- 0.8671693041
PARAM$finalmodel$min_data_in_leaf <- 3245
PARAM$finalmodel$envios <- 2534
PARAM$finalmodel$bagging_fraction <- 0.7068483128
PARAM$finalmodel$bagging_freq <- 6
PARAM$finalmodel$lambda_l1 <- 0.2402925093
PARAM$finalmodel$lambda_l2 <- 34.5610764140
PARAM$finalmodel$max_depth <- 6
PARAM$finalmodel$min_split_gain <- 9.61456772442274
PARAM$finalmodel$max_bin <- 279
PARAM$finalmodel$min_gain_to_split <- 0.3610344665
PARAM$finalmodel$min_sum_hessian_in_leaf <- 1
