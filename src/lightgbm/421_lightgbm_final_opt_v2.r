...
### HIPERPARAM. ORIGINALES DEL SCRIPT
...
##### HIPERPARAM OPTIMIZADOS CORRIDA BO.

# Nuevos hiperparámetros proporcionados
PARAM$finalmodel$num_iterations <- 518
PARAM$finalmodel$learning_rate <- 0.057707365
PARAM$finalmodel$feature_fraction <- 0.650238239
PARAM$finalmodel$min_data_in_leaf <- 341
PARAM$finalmodel$num_leaves <- 105
PARAM$finalmodel$max_bin <- 31
PARAM$finalmodel$max_depth <- 9
PARAM$finalmodel$bagging_fraction <- 0.93200442
PARAM$finalmodel$bagging_freq <- 0
#PARAM$finalmodel$lambda_l1 <- 0.071296473
#PARAM$finalmodel$lambda_l2 <- 99.50353892
PARAM$finalmodel$min_sum_hessian_in_leaf <- 9.928082017
...
modelo <- lgb.train(
  ...
  param = list(
    ...
    bagging_fraction = PARAM$finalmodel$bagging_fraction, #### HIPERPARAM AGREGADOS
    bagging_freq = PARAM$finalmodel$bagging_freq, #### HIPERPARAM AGREGADOS
   # lambda_l1 = PARAM$finalmodel$lambda_l1, #### HIPERPARAM AGREGADOS
    #lambda_l2 = PARAM$finalmodel$lambda_l2, #### HIPERPARAM AGREGADOS
    min_gain_to_split = PARAM$finalmodel$min_gain_to_split, #### HIPERPARAM AGREGADOS
    min_sum_hessian_in_leaf = PARAM$finalmodel$min_sum_hessian_in_leaf, #### HIPERPARAM AGREGADOS
...
cortes <- seq(11298, 11298, by = 1) ### Modificado para enviar solo el mejor corte
