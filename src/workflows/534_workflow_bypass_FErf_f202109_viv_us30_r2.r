# Corrida general del Workflow BYPASS ETAPA FE_rf con undersampling = 0.3 en linea 308 y rank 2
...
wf_sept_bypassFErf_us30_r2 <- function( pnombrewf )
{
...
#  FErf_attributes_base( arbolitos= 20, ## BYPASS A ESTA ETAPA
#    hojas_por_arbol= 16,
#    datos_por_hoja= 1000,
#    mtry_ratio= 0.2
#  )
