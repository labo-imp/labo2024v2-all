...
)
{
  ...
  param_local$train$training <- c(202008, 202009,202010)
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202003,202004,202005)
  param_local$train$validation <- c( 202007 )
...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$training <- c( 
     202005,202004,202003,202002,202001,201901)
  param_local$train$validation <- c(202006)
