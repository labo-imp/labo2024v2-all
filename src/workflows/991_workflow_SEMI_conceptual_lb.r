...
TS_strategy_meses1 <- function( pinputexps )
{
  ...
  param_local$train$testing <- c(201912)
  param_local$train$validation <- c(201911)
...
TS_strategy_meses3 <- function( pinputexps, ruta )
{
  ...
  param_local$train$training <- c(
    ...
    202011, 202010, 202009, 202008, 202007, 202005
    #202004, 202003, 202002, 202001, 201912, 201911 
    #201909, 201908, 201907, 201906, 201904, 201903
  )
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  ht0 <- HT_tuning_semillerio(
    semillerio = 10, # semillerio dentro de la Bayesian Optim
