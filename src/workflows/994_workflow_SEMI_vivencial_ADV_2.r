...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$undersampling <- 0.5 # MOD, us 0.5
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.5 # MOD, us 0.5
  param_local$final_train$clase_minoritaria <- c( "BAJA+1", "BAJA+2")
  param_local$final_train$training <- c(
    202107, 202106, 202105, 202104, 202103, 202102, 202101, 
    202012, 202011, 202010, 202009, 202008, 202007, 
    202006,  # NOExcluyo por variables rotas
  ...
  param_local$train$training <- c(
    ...
    202012, 202011, 202010, 202009, 202008, 202007, 
    202006,   # NO Excluyo por variables rotas
    202005, 202004, 202003, 202002, 202001,
    201912, 201911,
    201910, # NOExcluyo por variables rotas
    201909, 201908, 201907, 201906,
    201905, # NO Excluyo por variables rotas
    201904, 201903
  )
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$envios_salto <- 125L ## Modificado
...
wf_SEMI_sep_ADV_2 <- function( pnombrewf )
{
  param_local <- exp_wf_init( pnombrewf ) # linea fija

  DT_incorporar_dataset_competencia2024()

  CA_catastrophe_base( metodo="Ninguno") #MODIFICADO
  FEintra_manual_base()
