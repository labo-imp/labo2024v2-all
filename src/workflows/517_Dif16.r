...
)
{
  ...
  param_local$train$training <- c(201909,201910,201911)
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 201909,201910,201911)
  param_local$train$validation <- c( 202001)
...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$validation <- c(201912)
  param_local$train$testing <- c(202001)
