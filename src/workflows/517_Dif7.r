...
)
{
  ...
  param_local$train$training <- c( 202011,202012,202101)
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202006,202007,202008)
  param_local$train$validation <- c( 202009 )
...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$training <- c( 
     20208,202007,202006,202005,202004,202003)
  param_local$train$validation <- c(202009)
  param_local$train$testing <- c(202010)
