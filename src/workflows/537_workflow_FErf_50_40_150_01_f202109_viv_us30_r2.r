...
# FErf con num_it = 50, num_leaves = 40, min_data = 150, feat_frac = 0.1
# limpio la memoria
...
wf_sept_FErf_50_40_150_01_us30_r2 <- function( pnombrewf )
{
  ...
  FErf_attributes_base( arbolitos= 50, ### MODIFICADO
    hojas_por_arbol= 40, ### MODIFICADO
    datos_por_hoja= 150, ### MODIFICADO
    mtry_ratio= 0.1
  )
...
wf_sept_FErf_50_40_150_01_us30_r2()
