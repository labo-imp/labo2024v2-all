...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(202105,	202104,	202103,	202102,	202101,	202012,	
                                        202011,	202002,	202001,	201912,	201911,	201910)


  param_local$train$training <- c(202103, 202102, 202101, 202012, 202011, 202002, 202001, 
...
wf_12m_SinCovid <- function( pnombrewf )
{
