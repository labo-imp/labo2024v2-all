...
)
{
  ...
  param_local$train$training <- c(201906,201907,201908)
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 201906,201907,201908)
  param_local$train$validation <- c( 201910)
...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$validation <- c(201909)
  param_local$train$testing <- c(201910)
