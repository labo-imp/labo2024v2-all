...
# Experimento Base   
  param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012,
  ...
  param_local$train$training <- c(202103, 202102, 202101, 202012, 202011, 
                                  ...
                                  201902, 201901)
# Eliminacion de marzo y abril 2020 
  #param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012,
   #                                     202011, 202010, 202009, 202008, 202007, 202006,
    #                                    202005, 202002, 202001, 201912, 201911, 201910,
...
# Eliminacion de 2019 y marzo y abril 2020 
  #param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012,
   #                                     202011, 202010, 202009, 202008, 202007, 202006,
...
# Elimiacion de marzo a julio 2020
  #param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012,
...
# Eliminacion marzo a octubre 2020 
  #param_local$final_train$training <- c(202105, 202104, 202103, 202102, 202101, 202012,
