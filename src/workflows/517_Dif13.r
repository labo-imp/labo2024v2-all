...
)
{
  ...
  param_local$train$training <- c(2005,202006,202007)
...
CN_canaritos_asesinos_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 201912,202001,202002)
...
TS_strategy_base7 <- function( pinputexps )
{
  ...
  param_local$train$validation <- c(202003)
  param_local$train$testing <- c(202004)
