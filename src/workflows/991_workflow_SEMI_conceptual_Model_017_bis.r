...
FEhist_base <- function( pinputexps)
{
  ...
  param_local$lag2 <- TRUE # me engraso con los lags de orden 2
  param_local$lag3 <- TRUE # me engraso con los lags de orden 3
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$undersampling <- 0.80
