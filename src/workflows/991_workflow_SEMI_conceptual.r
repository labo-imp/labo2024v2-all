...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(201901, 201902, 201903, 201904, 201905, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)


  param_local$train$testing <- c(202107)
  param_local$train$validation <- c(202106)

  param_local$train$training <-c(201901, 201902, 201903, 201904, 201905, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$train$repeticiones_exp <- 5 #cambio OJO
  ...
  param_local$lgb_param <- list(
    ...
    num_leaves = c(20L, 200L, "integer"), #agregado
    max_bin = 31L, # lo debo dejar fijo, no participa de la BO

    num_iterations = 99999L, # un numero muy grande *******agregue un 9
    ...
    min_data_in_leaf = c(1L, 2500L, "integer"), #agregado
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  #CA_catastrophe_base( metodo="MachineLearning") CAMBIO
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    ...
    repeticiones_exp = 10  # cantidad de repeticiones del semillerio (puede cambiarse para tener mas resultados])
  )
