...
min_data_in_leaf = c(1, 2500,"integer"),   # deriva en min_data_in_leaf
num_leaves = c(20, 200,"integer")      # deriva en num_leaves
  )
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  #CA_catastrophe_base( metodo="MachineLearning")   # Modificado segun experimento segun Catastrophe Analysis
  FEintra_manual_base()
  DR_drifting_base(metodo="deflacion") # Modificado segun experimento DR Data Drifting
  FEhist_base()
