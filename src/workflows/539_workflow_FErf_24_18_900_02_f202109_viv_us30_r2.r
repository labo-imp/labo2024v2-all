...
# FErf con num_it = 24, num_leaves = 18, min_data = 900, feat_frac = 0.2
# limpio la memoria
...
wf_sept_FErf_24_18_900_02_us30_r2 <- function( pnombrewf )
{
  ...
  FErf_attributes_base( arbolitos= 24, ### MODIFICADO
    hojas_por_arbol= 18, ### MODIFICADO
    datos_por_hoja= 900, ### MODIFICADO
    mtry_ratio= 0.2
  )
...
wf_sept_FErf_24_18_900_02_us30_r2()
